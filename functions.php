...
function angelamusic_files() {
    ...
    wp_enqueue_style('angelamusic_main_files', get_template_directory_uri() . '/style.css', array(), '1.0.1', 'all');
    wp_enqueue_script('angelamusic_js', get_template_directory_uri() . '/assets/js/index.js', '1.0.1', true);
    wp_enqueue_script('scrollout_js', get_template_directory_uri() . '/assets/js/vendors/scrollout.min.js', '1.0.0', true);
    // wp_enqueue_script('YouTube_api', "https://www.youtube.com/iframe_api", '1.0.0', true);
}
